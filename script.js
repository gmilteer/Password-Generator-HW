...
// Confirm the rest of the character conditions
  ...
  if(allChars.length===0){
    alert("You must select at least 1 type of characters to generate a new password!\nPlease start over.");
  }

  // Run for loop to use confirmed information and gererate password as a result
  else{
